 ...
 * @public
 */
export class BunSQLiteDriver implements SyncDriver {
  /**
   * Driver metadata.
   */
  ...
  constructor(config: DriverConfig) {
    if (typeof (globalThis as any).Bun === 'undefined') {
      throw new Error(
        '@rinari/bun-sqlite requires Bun runtime. This driver is not compatible with Node.js. Please use @rinari/sqlite for Node.js.'
      );
    }
